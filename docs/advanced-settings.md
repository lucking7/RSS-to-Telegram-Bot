...
| `HIGH_FREQUENCY_FEED_PATTERNS` | URL substrings for feeds that need second-level monitoring.                 | `/tencent/finance/newslist;/kaipanla/news`    | Tencent finance, Kaipanla, Longbridge flash, Jin10 |
